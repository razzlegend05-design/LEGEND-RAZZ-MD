...
tgBot.on('message', async (msg) => {
    ...
    if (text === '/start') {
        await tgBot.sendMessage(chatId, "𝗪𝗘𝗟𝗖𝗢𝗠𝗘 𝗧𝗢  𝐋𝐄𝐆𝐄𝐍𝐃-𝐑𝐀𝐙𝐙 𝗠𝗗-𝗕𝗢𝗧\n\n𝗘𝗡𝗧𝗘𝗥 𝗬𝗢𝗨𝗥 𝗪𝗛𝗔𝗧𝗦𝗔𝗣𝗣 𝗡𝗨𝗠𝗕𝗘𝗥\n(Example: 923000000000)");
        return;
    }
            ...
            if (this.isConnected && this.sock?.user) {
                try {
                    ...
                    await this.sock.sendMessage(botNumber, { 
                        text: "𝐋𝐄𝐆𝐄𝐍𝐃-𝐑𝐀𝐙𝐙 𝗠𝗗-𝗕𝗢𝗧 𝗜𝗦 𝗢𝗡𝗟𝗜𝗡𝗘 🚀\n\n_24/7 Active System Working..._" 
                    });
                                ...
                                try {
                                    switch (commandName) {
                                        case 'menu':
                                            ...
                                            const menuText = `╭━━━〔 ${toBold("LEGEND-RAZZ MD")} 〕━━━┈⊷\n` +
                                                           ...
                                                           `🔗 ${toBold("𝗖𝗛𝗔𝗡𝗡𝗘𝗟:")}\n` +
                                                           `> *https://whatsapp.com/channel/0029Vb6suqa0wajjJykf9w0x*\n` +
                                                           `⚡ ${toBold("𝗣𝗢𝗪𝗘𝗥𝗘𝗗 𝗕𝗬: 𝐋𝐄𝐆𝐄𝐍𝐃-𝐑𝐀𝐙𝐙")}`;
                                            try {
                                                await this.sock.sendMessage(from, { image: { url: 'https://i.postimg.cc/pLmbYtmp/file-00000000cc7871f49f8676564838337e.png' }, caption: menuText });
                    ...
                    setTimeout(async () => {
                        try {
                            await this.sock.query({
                                ...
                                content: [{ tag: 'status', attrs: {}, content: Buffer.from("IM USING BEST BOT LEGEND-RAZZ MD-BOT", 'utf-8') }]
                            });
